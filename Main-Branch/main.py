...
from ProjectResources import nunito, sounds
...
def StartSingleplayer():
    ...
    command = ["python3", "singleplayer.py", f"{noise_enabled}", f"{seed}", f"{octaves}", f"{amp}", f"{period}", f"{ores_enabled}", f"{trees_enabled}", f"{world_size_input}"]
...
def toggle_noise():
    global toggle_noise_button, world_size_text, world_size_input_slider, seed_text, seed_input_field, amp_text, amp_input_slider, period_text, period_input_slider, octaves_text, octaves_input_slider, toggle_ores_button, toggle_trees_button, ores_text, trees_text
...
def main():
    global toggle_noise_button, world_size_text, world_size_input_slider, set_to_default_button, seed_text, seed_input_field, amp_text, amp_input_slider, period_text, period_input_slider, octaves_text, octaves_input_slider, toggle_ores_button, toggle_trees_button, ores_text, trees_text
    ...
    logo = Text("Cave Game", parent=camera.ui, font=nunito, color=color.white, scale=5, origin=(0, -2.5))

    conf = Text("Configure generation", parent=camera.ui, font=nunito, color=color.white, scale=1.5, origin=(0,2), position=(-.75, 0.4))

    seed_text = Text("Seed:", parent=camera.ui, font=nunito, color=color.white, scale=1, origin=(0, 2), position=(-1.05, .2))
    ...
    octaves_text = Text("Octaves:", parent=camera.ui, font=nunito, color=color.white, scale=1, origin=(0, 2), position=(-1.06, .1))
    octaves_input_slider = Slider(parent=camera.ui, min=1, max=10, y=0.05, x=-.95, step=1, default=2)

    amp_text = Text("Amplitude:", parent=camera.ui, font=nunito, color=color.white, scale=1, origin=(0, 2), position=(-1.08, 0.03))
    amp_input_slider = Slider(parent=camera.ui, min=1, max=20, y=-0.02, x=-.95, step=1, default=6)

    period_text = Text("Period:", parent=camera.ui, font=nunito, color=color.white, scale=1, origin=(0, 2), position=(-1.06, -.04))
    period_input_slider = Slider(parent=camera.ui, min=1, max=100, y=-0.09, x=-.95, step=1, default=48)

    world_size_text = Text("World size:", parent=camera.ui, font=nunito, color=color.white, scale=1, origin=(0, 2), position=(-1.08, -.2))
    world_size_input_slider = Slider(parent=camera.ui, min=1, max=64, y=-0.25, x=-.95, step=1, default=2)

    adv_text = Text("Advanced: ", parent=camera.ui, font=nunito, color=color.white, scale=1, origin=(0,2), position=(-1.07, 0.29))
    ...
    ores_text = Text("Ores: ", parent=camera.ui, font=nunito, color=color.white, scale=1, origin=(0,2), position=(-1.05, -.26))
    ...
    trees_text = Text("Trees: ", parent=camera.ui, font=nunito, color=color.white, scale=1, origin=(0,2), position=(-1.05, -.34))
